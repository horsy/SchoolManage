...
<div style="height: 100%; width: 100%;">
	<iframe name="saveEditUser" src="" style="display: none"></iframe>
	<form action="saveEditUser.html" method="post" name="editUserForm"
		target="saveEditUser">
		<table border="0" class="addUserTable">
			<tr>
				...
				<td class="inputTd">
					<div id="loginNameDiv" class="change_password_input_div">
						<input class="input" name="loginName" type="text" value="${user.loginName }"
							readonly>
					</div>
				</td>
			...
			<tr>
				...
				<td class="addUserExplain">
					可以是字母、数字、特殊字符，也可以是汉字等其他字符。<font color="red">密码为空则不修改</font>
				</td>
			</tr>
			<tr>
				<td colspan="3">
		...
		<table border="0" style="width: 90%;">
			<tr>
				...
				<td style="width: 100px;">
					<div class="cancel"
						onclick="document.body.removeChild(document.getElementById('bgDiv_2_bg'));document.body.removeChild(document.getElementById('bgDiv_2'));"
						onmousedown="this.className='cancel_down'"
						onmouseup="this.className='cancel'"
						onmouseout="this.className='cancel'"></div>
				</td>
				<td style="width: 35px;">
				</td>
				<td style="width: 100px;">
					<div class="change_password_submint"
						onclick="document.forms.editUserForm.submit();"
						onmousedown="this.className='change_password_submint_down'"
						onmouseup="this.className='change_password_submint'"
						onmouseout="this.className='change_password_submint'"></div>
				</td>
			</tr>
		</table>
...
function editUser_setform(){
	document.getElementById("rightId").value=${user.rightId};
}
//-->
</script>