...
<div style="height: 100%; width: 100%;">
	<iframe name="saveAddingTeacherLevel" src="" style="display: none"></iframe>
	<form action="saveAddingTeacherLevel.html" method="post" name="addTeacherLevelForm"
		target="saveAddingTeacherLevel">
			...
			<tr>
				...
				<td class="inputTd">
					<div id="typeNameDiv" class="change_password_input_div"
						...
						<input class="input" type="text" name="typeName" id="typeName" maxlength="16"
		...
		<table border="0" style="width: 90%;">
			<tr>
				...
				<td style="width:100px;">
					<div class="change_password_submint" onclick="document.forms.addTeacherLevelForm.submit();" onmousedown="this.className='change_password_submint_down'" onmouseup="this.className='change_password_submint'" onmouseout="this.className='change_password_submint'"></div>
				</td>
			</tr>
		</table>
	</form>
