...
<div style="height: 100%; width: 100%;">
	<iframe name="saveAddingGrade" src="" style="display: none"></iframe>
	<form action="saveAddingGrade.html" method="post" name="addGradeForm"
		target="saveAddingGrade">
			...
			<tr>
				...
				<td class="inputTd">
					<div id="gradeNameDiv" class="change_password_input_div"
						...
						<input class="input" type="text" name="gradeName"
			...
			<tr>
				...
				<td>
					<div id="inSchoolYearDiv" class="change_password_input_div"
						onMouseOut="javascript:loginPage_changeClassName(this,'change_password_input_div',event)"
						onMouseOver="javascript:loginPage_changeClassName(this,'change_password_input_div_move_in',event)">
						<input class="input" type="text" name="inSchoolYear"
							onfocus="javascript:loginPage_changeClassName(this.parentNode,'change_password_input_div_move_in',event)"
							onblur="javascript:loginPage_changeClassName(this.parentNode,'change_password_input_div',event)">
					</div>
				</td>
		...
		<table border="0" style="width: 90%;">
			<tr>
				...
				<td style="width:100px;">
					<div class="change_password_submint" onclick="document.forms.addGradeForm.submit();" onmousedown="this.className='change_password_submint_down'" onmouseup="this.className='change_password_submint'" onmouseout="this.className='change_password_submint'"></div>
				</td>
			</tr>
		</table>
		<input type="hidden" name="levelId" id="levelId" value="0" >
