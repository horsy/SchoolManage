...
<div style="height: 100%; width: 100%;">
	<iframe name="saveAddingTeacher" src="" style="display: none"></iframe>
	<form action="saveAddingTeacher.html" method="post" name="addTeacherForm"
		target="saveAddingTeacher">
			...
			<tr>
				...
				<td>
					<div id="telephoneDiv" class="change_password_input_div"
						onMouseOut="javascript:loginPage_changeClassName(this,'change_password_input_div',event)"
						onMouseOver="javascript:loginPage_changeClassName(this,'change_password_input_div_move_in',event)">
						<input class="input" type="text" name="telephone" maxlength="16"
							onfocus="javascript:loginPage_changeClassName(this.parentNode,'change_password_input_div_move_in',event)"
							onblur="javascript:loginPage_changeClassName(this.parentNode,'change_password_input_div',event)">
					</div>
				</td>
		...
		<table border="0" style="width: 90%;">
			<tr>
				...
				<td style="width:100px;">
					<div class="change_password_submint" onclick="document.forms.addTeacherForm.submit();" onmousedown="this.className='change_password_submint_down'" onmouseup="this.className='change_password_submint'" onmouseout="this.className='change_password_submint'"></div>
				</td>
			</tr>
		</table>
	</form>
