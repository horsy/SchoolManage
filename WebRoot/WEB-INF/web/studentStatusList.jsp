...
<div style="overflow-y: auto;">
	<div>
		<iframe name="delUserForm" id="delUserForm" style="display: none;"
			src=""></iframe>
		<center>
			<table style="margin-top: 30px; width: 75%;" id="studentStatusTable">
				<caption class="captionStyle">
					学生状态
				</caption>
				<tr>
					<td colspan="3" class="tdList">
						<s:iterator value="%{studentStatusList}" status="objList">
			...
			<table style="width:75%;">
				<tr>
					...
					<td class="add show_user_list_bottom_height"
						onclick="javascript:studentStatus_add()"
					...
					<td class="del show_user_list_bottom_height"
						onclick="javascript:studentStatus_del('studentStatusTable')"
