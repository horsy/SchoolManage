...
<div style="height: 100%; width: 100%;">
	<iframe name="saveAddingPoliticalOrientation" src="" style="display: none"></iframe>
	<form action="saveAddingPoliticalOrientation.html" method="post" name="addPoliticalOrientationForm"
		target="saveAddingPoliticalOrientation">
			...
			<tr>
				...
				<td class="inputTd">
					<div id="typeNameDiv" class="change_password_input_div"
						...
						<input class="input" type="text" name="politicalOrientation" id="politicalOrientation" maxlength="10"
		...
		<table border="0" style="width: 90%;">
			<tr>
				...
				<td style="width:100px;">
					<div class="change_password_submint" onclick="document.forms.addPoliticalOrientationForm.submit();" onmousedown="this.className='change_password_submint_down'" onmouseup="this.className='change_password_submint'" onmouseout="this.className='change_password_submint'"></div>
				</td>
			</tr>
		</table>
	</form>
