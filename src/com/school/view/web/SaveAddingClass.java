...
public class SaveAddingClass extends ActionSupport implements
		ModelDriven<ClassDomain> {

	/**
	 * 
	 */
	private static final long serialVersionUID = -9094774677783200070L;
	...
	public String execute() throws Exception {
		...
		String success = "班级添加成功";
		if (info == null || "".equals(info)) {
			// 验证通过
//			clas.setSchoolId(serviceDao.getLocalSchoolInfo().getId());
			serviceDao.addClass(clas);
			info = success;
		}
