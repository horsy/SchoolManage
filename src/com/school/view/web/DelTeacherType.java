...
public class DelTeacherType extends ActionSupport {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3638651054916688002L;
	@Autowired
	...
	public String execute() throws Exception {
		...
		if (id != null && id.length() > 0) {
			if (id.indexOf(";") > -1 || id.indexOf("'") > -1) {
				...
				serviceDao.deleteTeacherTypeByIdArray(idA);
				info = success;
			}
		...
		if (info.equals(success)) {
			response.getWriter().append("parent.systemSet('teacherLevel');");
		} else {
