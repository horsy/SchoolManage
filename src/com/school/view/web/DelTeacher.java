...
public class DelTeacher extends ActionSupport {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6601613450216866486L;
	@Autowired
	...
	public String execute() throws Exception {
		...
		if (id != null && id.length() > 0) {
			if (id.indexOf(";") > -1 || id.indexOf("'") > -1) {
				...
				serviceDao.deleteTeacherByIdArray(idA);
				info = success;
			}
