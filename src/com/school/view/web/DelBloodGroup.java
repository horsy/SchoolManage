...
public class DelBloodGroup extends ActionSupport {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5429806665302462356L;
	@Autowired
	...
	public String execute() throws Exception {
		...
		if (id != null && id.length() > 0) {
			if (id.indexOf(";") > -1 || id.indexOf("'") > -1) {
				...
				serviceDao.deleteBloodGroupByIdArray(idA);
				info = success;
			}
		...
		if (info.equals(success)) {
			response.getWriter().append("parent.systemSet('bloodGroup');");
		} else {
