...
public class SaveAddingTeacher extends ActionSupport implements
		ModelDriven<TeacherDomain> {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4024121942090699093L;
	...
	public String execute() throws Exception {
		...
		String success = "教师添加成功";
		if (info == null || "".equals(info)) {
			// 验证通过
			serviceDao.addTeacher(teacher);
			info = success;
		}
