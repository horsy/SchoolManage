...
public class DelStudentStatus extends ActionSupport {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5719196458493712190L;
	@Autowired
	...
	public String execute() throws Exception {
		...
		if (id != null && id.length() > 0) {
			if (id.indexOf(";") > -1 || id.indexOf("'") > -1) {
				...
				serviceDao.deleteStudentStatusByIdArray(idA);
				info = success;
			}
		...
		if (info.equals(success)) {
			response.getWriter().append("parent.systemSet('studentStatus');");
		} else {
