...
public class DelPoliticalOrientation extends ActionSupport {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7516331670097195967L;
	@Autowired
	...
	public String execute() throws Exception {
		...
		if (id != null && id.length() > 0) {
			if (id.indexOf(";") > -1 || id.indexOf("'") > -1) {
				...
				serviceDao.deletePoliticalOrientationByIdArray(idA);
				info = success;
			}
