...
public class DelClass extends ActionSupport {

	/**
	 * 
	 */
	private static final long serialVersionUID = -917708684167457307L;
	@Autowired
	...
	public String execute() throws Exception {
		...
		if (id != null && id.length() > 0) {
			if (id.indexOf(";") > -1 || id.indexOf("'") > -1) {
				...
				serviceDao.delClassByIdArray(idA);
				info = success;
			}
